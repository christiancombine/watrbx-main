...
typeof Roblox == "undefined" && (Roblox = {}), Roblox.SignupFormValidatorGeneric = function() {
    ...
    v2UsernameAndPasswordRulesEnabled = parseInt($(".signup-or-log-in").attr("data-v2-username-password-rules-enabled"));
    return {
        invalidBirthday: n,
        selectedBirthday: nt,
        genderSelected: g,
        usernameTooLong: d,
        usernameTooShort: k,
        usernameRegexInvalid: p,
        usernameInvalid: y,
        usernameStartsOrEndsWithUnderscore: v2UsernameAndPasswordRulesEnabled == 1 ? b : null,
        usernameHasMoreThanOneUnderscore: v2UsernameAndPasswordRulesEnabled == 1 ? w : null,
        passwordIsUsername: e,
        passwordsMatch: v,
        weakPassword: v2UsernameAndPasswordRulesEnabled == 1 ? f : u,
        passwordTooShort: v2UsernameAndPasswordRulesEnabled == 1 ? tt : c,
        passwordTooLong: v2UsernameAndPasswordRulesEnabled == 1 ? null : a,
        passwordEnoughLetters: v2UsernameAndPasswordRulesEnabled == 1 ? null : h,
        passwordEnoughNumbers: v2UsernameAndPasswordRulesEnabled == 1 ? null : s,
        passwordContainsSpaces: v2UsernameAndPasswordRulesEnabled == 1 ? null : o
    }
    ...
    tooShort: "Password can be of minimum 8 length",
...
"use strict";
var signupOrLogin = angular.module("SignupOrLogin", ["roblox.formEvents"]);

; // ~/viewapp/common/signupOrLogin/controllers/captchaController.js
"use strict";
signupOrLogin.controller("CaptchaController", ["$scope", "$http", "$rootElement", "captchaService", function(n, t, i, r) {
    var u = function() {
        Recaptcha.reload()
    };
    n.isSubmitting = !1, n.submitCaptcha = function(t) {
        r.submitCaptcha(t, u, n)
        ...
        n.captchaResponse = "", n.captchaFlowType = i.captchaFlow, n.username = i.username, u(), n.isSectionShown = !0
    })
}]);
...
signupOrLogin.controller("SignupController", ["$scope", "$http", "displayService", "captchaService", "signupService", function(n, t, i, r, u) {
    n.signup = {}, n.signup.gender = Roblox.SignupOrLogin.GenderType.unknown, n.setGender = function(t, i) {
        ...
        var u, i, r;
        return n.signupForm.birthdayMonth.$invalid ? !1 : (u = n.signup.birthdayYear ? n.signup.birthdayYear : "2014", i = new Date(n.signup.birthdayMonth + " " + t + " " + u), Object.prototype.toString.call(i) !== "[object Date]" || isNaN(i.getTime())) ? !1 : i.getDate().toString() != t ? !1 : (r = new Date, i.getTime() < r.getTime() && i.getFullYear() > r.getFullYear() - 100)
    ...
    }, n.isSectionShown = !0, n.$on("display:updated", function(t, i) {
        n.isSectionShown = i === Roblox.SignupOrLogin.SectionType.signup, n.isSectionShown && (n.signup = {}, n.badSubmit = !1, n.signupForm.$setPristine(), n.signupForm.$generalError = !1)
...
"use strict";
signupOrLogin.directive("rbxShowSection", ["displayService", function(n) {
    return {
        restrict: "A",
        scope: {
            sectionType: "="
        ...
        link: function(t, i) {
            i.bind("click", function() {
                n.setDisplayState(t.sectionType)
            })
        }
    }
}]);
...
signupOrLogin.directive("rbxValidUsername", ["$http", function(n) {
    return {
        ...
        link: function(t, i, r, u) {
            t.onChange = function() {
                var f = t.signup.username === "" || angular.isUndefined(t.signup.username),
                    i = "",
                    r = !1;
                f ? (r = !0, i = "Please enter a username.") : (i = Roblox.Animated2014SignupFormValidator.verifyUsername(t.signup.username), i !== "" && (r = !0)), u.$setValidity("validusername", !r), r ? u.$validationMessage = i : n({
                    method: "GET",
                    ...
                    var i = !0,
                        r = !0,
                        t = "";
                    n.data == 1 && (i = !1, t = Roblox.Resources.AnimatedSignupFormValidator.alreadyTaken), n.data == 2 && (r = !1, t = Roblox.Resources.AnimatedSignupFormValidator.cantBeUsed), u.$setValidity("unique", i), u.$setValidity("moderated", r), u.$invalid ? t != "" && (u.$validationMessage = t) : u.$validationMessage = ""
                })
            }, t.onChange()
        }
    }
...
"use strict";
signupOrLogin.factory("displayService", ["$rootScope", function(n) {
    var t = Roblox.SignupOrLogin.SectionType.signup;
    return {
        getDisplayState: function() {
            return t
        },
        setDisplayState: function(i) {
            t = i, n.$broadcast("display:updated", i), n.$apply()
        }
    }
}]);
    ...
    var r = function(r) {
        ...
        u = function(t) {
            ...
            n({
                ...
                i.setDisplayState(Roblox.SignupOrLogin.SectionType.twostep)
            }).error(function() {
        ...
        f = function(t, i) {
            var f = angular.element(t.target),
                e = f.data("two-step-verification-api-url");
            n({
                method: "POST",
                url: e,
                data: $.param({
...
"use strict";
signupOrLogin.factory("signupService", ["$http", "captchaService", "$rootElement", function(n, t) {
    var r = function(i) {
            var o = angular.element("#SignupButton"),
                s = o.data("signup-api-url"),
                r = {},
                e = angular.element(".signup-or-log-in"),
                f = e.data("params"),
                u;
            typeof f == "undefined" && (f = {}), $.each(f, function(n, t) {
                r[n] = t
                ...
                birthday: i.signup.birthdayDay + " " + i.signup.birthdayMonth + " " + i.signup.birthdayYear,
                gender: i.signup.gender,
                context: i.signupForm.context
            }), n({
                method: "POST",
                url: s,
                data: $.param(r),
