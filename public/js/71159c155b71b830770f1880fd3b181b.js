;// bundle: header___e23c4dcbbcb2815d4204297122365d7d_m
;// files: GPTAdScript.js, leancore/libs/json3.min.js, roblox.js, leancore/RobloxHeaderInit.js, jquery.cookie.js, utilities/performance.js
...
Roblox=Roblox||{},Roblox.Performance=function(){function f(){var n=i.data("performance-relative-value");return Math.random()<n&&"performance"in window&&"timing"in window.performance&&"navigation"in window.performance}function e(){t=i.data("internal-page-name")}function o(){n=window.performance.timing}function s(n,t,i,r){var u=[];return u.push(n),u.push(t),u.push(i),r=Math.floor(r),u.push(r),u}function u(n,t,i,r){if(typeof GoogleAnalyticsEvents!="undefined"&&r>0){var u=s(n,t,i,r);GoogleAnalyticsEvents.FireEvent(u)}}function h(){if(n.domComplete&&n.navigationStart){var i=Math.floor(n.domComplete-n.navigationStart);i>0&&u(r,t,"PageLoad",i)}}function c(){if(n.responseEnd&&n.navigationStart){var i=Math.floor(n.responseEnd-n.navigationStart);i>0&&i.toString().length<6&&u(r,t,"FirstByte",i)}}function l(n,t){if(window.performance&&typeof window.performance.mark=="function"){typeof t=="undefined"&&(t="navigationStart");var i=t+":"+n;window.performance.mark(i)}}function a(n){var t=n.split(":"),r=t[0],i=t[1];t.length>2&&(i=t[2]+":"+i),window.performance.measure(i+"_measure",r,n)}function v(){var n,t,i;if(typeof window.performance.getEntriesByType=="function"&&(n=window.performance.getEntriesByType("mark"),n&&n.length>0))for(t=0;t<n.length;t++)i=n[t],a(i.name)}function y(){var n,i,f,e;if(typeof window.performance.getEntriesByType=="function"&&(n=window.performance.getEntriesByType("measure"),n&&n.length>0))for(i=0;i<n.length;i++)f=n[i],e=Math.floor(f.duration),u(r,t,f.name,e)}var n,r="Performance",t,i;return $(window).load(function(){i=$("#rbx-body"),i&&f()&&(o(),e(),typeof t!="undefined"&&(h(),c(),v(),y()))}),{setPerformanceMark:l}}();
