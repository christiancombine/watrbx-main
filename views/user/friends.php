...
$pagebuilder->addresource('cssfiles', '/CSS/Base/CSS/FetchCSS?path=page___0d3aed43bf249bbe40467c99baad2280_m.css');
...
<div class="row page-content" ng-modules="robloxApp, ui.bootstrap, friends, robloxApp.helpers" ng-cloak ng-controller="friendsController">
        ...
        <ul id="horizontal-tabs" class="nav nav-tabs" role="tablist">
            <li id="friends" class="rbx-tab" ng-class="{'active': currentData.activeTab == 'friends', 'subtract-item': !currentData.isMyProfile}" ui-sref="friends">
                <a class="rbx-tab-heading">
                    <span class="rbx-lead">Friends</span>
                </a>
            </li>
            <li id="following" class="rbx-tab" ng-class="{'active': currentData.activeTab == 'following', 'subtract-item': !currentData.isMyProfile}" ui-sref="following">
                <a class="rbx-tab-heading">
                    <span class="rbx-lead">Following</span>
                </a>
            </li>
            <li id="followers" class="rbx-tab" ng-class="{'active': currentData.activeTab == 'followers', 'subtract-item': !currentData.isMyProfile}" ui-sref="followers">
                <a class="rbx-tab-heading">
                    <span class="rbx-lead">Followers</span>
                </a>
            </li>
            <li id="requests" class="rbx-tab" ng-show="currentData.isMyProfile" ng-class="{'active': currentData.activeTab == 'friend-requests', 'subtract-item': !currentData.isMyProfile}" ui-sref="friend-requests">
                <a class="rbx-tab-heading">
                    <span class="rbx-lead">Requests</span>
                </a>
            </li>
        </ul>
    ...
    <button ng-show="currentData.activeTab == 'friend-requests' && friendsContent.friends.data.TotalFriends > 0" type="button" class="rbx-btn-control-xs ignore-button" ng-click="declineAllFriendRequests()" ng-disabled="disabled">Ignore All</button>
    <span class="rbx-tooltip" tooltip-placement="bottom" tooltip="{{ currentData.tooltipLabel }}">
            ...
            <div class="friends-card">
                <div class="friends-image">
                    <div class="icon-container" ng-hide="currentData.activeTab == 'followers' || currentData.activeTab == 'friend-requests'">
                        <a ng-href="{{ friend.AbsoluteURL}}"> <span ng-show="friend.IsOnline && !friend.InGame && !friend.InStudio" class="rbx-icon-online" title="{{friend.LastLocation}}"></span></a>
                        <a ng-href="{{ friend.AbsolutePlaceURL }}"><span ng-show="friend.InGame && friend.IsOnline" class="rbx-icon-game" title="{{friend.LastLocation}}"></span></a>
                        <span ng-show="friend.InStudio && friend.IsOnline" class="rbx-icon-studio" title="{{friend.LastLocation}}"></span>
                    </div>
                ...
                <div class="button-container" ng-class="{ 'friend-requests': currentData.activeTab == 'friend-requests' }" ng-show="currentData.isMyProfile && currentData.activeTab != 'friends'">
                    <button ng-show="currentData.activeTab == 'following' && friend.ItemVisible" type="button" class="rbx-btn-control-xs unfollow" ng-click="unFollow(friend.UserId, friend)">Unfollow</button>
                    <button ng-show="currentData.activeTab == 'following' && !friend.ItemVisible" type="button" class="rbx-btn-secondary-xs follow" ng-click="follow(friend.UserId, friend)">Follow</button>
                    <button ng-show="currentData.activeTab == 'friend-requests' && friend.ItemVisible" type="button" class="rbx-btn-secondary-xs accept-friend" ng-click="acceptFriendRequest(friend.UserId, friend,currentData.currentPage)">Accept</button>
                    <button ng-show="currentData.activeTab == 'friend-requests' && friend.ItemVisible" type="button" class="rbx-btn-control-xs ignore-friend" ng-click="declineFriendRequest(friend.UserId, friend,currentData.currentPage)">Ignore</button>
                </div>
...
<div class="pager-holder">
    <ul class="pager rbx-pager" ng-show="currentData.totalPages > 1">
        <li class="rbx-pager-prev">
            <a ng-click="newPage(((currentData.currentPage /18) - 1))"><i class="rbx-icon-left"></i></a>
        </li>
        <li>
            <span>Page</span>
        </li>
        ...
        <li class="rbx-pager-next">
            <a ng-click="newPage(((currentData.currentPage /18) + 1))"><i class="rbx-icon-right"></i></a>
        </li>
    </ul>
</div>
    </div>
    ...
    <script type="text/ng-template" id="current-user-reached-friends-max.html">
        <div class="modal-content ">
            ...
            <div class="modal-footer">
                ...
                <p class="rbx-font-sm modal-footer-note">Unfriend someone before accepting any more Friend Requests.</p>
            </div><!-- /.modal-content -->
    </script>
</div><div>
    <script type="text/javascript">
    ...
    <script type="text/ng-template" id="requester-reached-friends-max.html">
        <div class="modal-content ">
            ...
            <div class="modal-footer">
                ...
                <p class="rbx-font-sm modal-footer-note">You can not accept their Friend Request until they remove a Friend.</p>
            </div><!-- /.modal-content -->
    </script>
</div><div>
    <script type="text/javascript">
    ...
    <script type="text/ng-template" id="something-went-wrong.html">
        <div class="modal-content ">
            ...
            <div class="modal-footer">
                ...
                <p class="rbx-font-sm modal-footer-note">Please check back in few minutes.</p>
            </div><!-- /.modal-content -->
    </script>
</div>
</div>
