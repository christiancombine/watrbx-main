...
/**
 * This class stands for BatchJobEx StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class BatchJobEx extends AbstractStructBase
{
    /**
     * The job
    ...
    /**
     * Constructor method for BatchJobEx
     * @uses BatchJobEx::setJob()
     * @uses BatchJobEx::setScript()
