...
/**
 * This class stands for ExecuteEx StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ExecuteEx extends AbstractStructBase
{
    /**
     * The jobID
    ...
    /**
     * Constructor method for ExecuteEx
     * @uses ExecuteEx::setJobID()
     * @uses ExecuteEx::setScript()
     * @param string $jobID
