...
$pagebuilder->addresource('cssfiles', '/CSS/Base/CSS/FetchCSS?path=page___c7df8deab88c3d1180f92e604da20017_m.css');
...
<div class="successful-message-div">
    <span class="rbx-icon-games"></span>
    <h1 class="successful-message-header">Thank you for installing ROBLOX.</h1>
    <p class="successful-message-description">It’s time to play! You can now browse and play the most popular games on ROBLOX.</p>
    <a href="/games">
        <button type="button" class="rbx-btn-primary-xs">
            Browse ROBLOX Games
        </button>
    </a>
</div>
...
<footer class="container-footer">
    <div class="footer">
        <ul class="row footer-links">
            <li class="col-xs-4 col-sm-2 footer-link"><a href="//corp.roblox.com" class="roblox-interstitial" target="_blank"><h2>About Us</h2></a></li>
            <li class="col-xs-4 col-sm-2 footer-link"><a href="//corp.roblox.com/jobs" class="roblox-interstitial" target="_blank"><h2>Jobs</h2></a></li>
            <li class="col-xs-4 col-sm-2 footer-link"><a href="//blog.roblox.com" class="roblox-interstitial" target="_blank"><h2>Blog</h2></a></li>
            <li class="col-xs-4 col-sm-2 footer-link"><a href="/Info/Privacy.aspx" target="_blank"><h2>Privacy</h2></a></li>
            <li class="col-xs-4 col-sm-2 footer-link"><a href="//corp.roblox.com/parents" class="roblox-interstitial" target="_blank"><h2>Parents</h2></a></li>
            <li class="col-xs-4 col-sm-2 footer-link"><a href="//en.help.roblox.com/" class="roblox-interstitial" target="_blank"><h2>Help</h2></a></li>
        </ul>
        <p class="footer-note">
            ROBLOX, "Online Building Toy", characters, logos, names, and all related indicia are trademarks of <a target="_blank" href="//corp.roblox.com" class="rbx-link roblox-interstitial">ROBLOX Corporation</a>, ©2015. Patents pending. ROBLOX is not sponsored, authorized or endorsed by any producer of plastic building bricks, including The LEGO Group, MEGA Brands, and K'Nex, and no resemblance to the products of these companies is intended. Use of this site signifies your acceptance of the <a href="/info/terms-of-service" target="_blank" class="rbx-link">Terms and Conditions</a>.
        </p>
    ...
    <div style="min-height: 275px; background-color: white;">
        ...
        <div class="RevisedFooter" >
            <div style="width:200px;margin:10px auto 0 auto;">
                <a href="/?returnUrl=%2Fdownload%2Fthankyou"><div class="RevisedCharacterSelectSignup"></div></a>
                <a class="HaveAccount" href="/newlogin?returnUrl=%2Fdownload%2Fthankyou">I have an account</a>
            </div>
        </div>
    </div>
</div>
...
<script type='text/javascript' src='https://js.rbxcdn.com/453a3526187103f27673584103a84bc7.js'></script>
...
<script type="text/javascript">
    ...
    <script type='text/javascript' src='https://js.rbxcdn.com/e22e6830ef07c8610a8b3ac6d2bd9088.js'></script>
...
<script type="text/javascript">
    ...
    <script type='text/javascript' src='https://js.rbxcdn.com/f1aac5995281c9bc2947c2111883e0ff.js'></script>
